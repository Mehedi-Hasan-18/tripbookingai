...
const slides = [
  {
    ...
    btnCss:"mt-4 flex items-center gap-2 text-sm font-semibold ml-26 px-4 py-2 rounded-full w-fit transition-colors"
  },
  {
    id: 2,
    img: "/image21.png",
    ...
    btnCss:"mt-4 flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-full w-fit transition-colors"
  },
  {
    id: 3,
    img: "/image22.png",
    ...
    btnLabel: "View More",
    btnColor: "bg-yellow-400 text-gray-900 hover:bg-yellow-300",
    customeCSS:"font-bold text-xl leading-snug mt-1 pr-5 bg-white text-black p-3 rounded rounded-xl mr-5",
    btnCss:"mt-4 flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-full w-fit transition-colors"
  },
];
...
const ImageCarousel = () => {
  ...
  return (
    <div className="relative flex items-center gap-4 max-w-6xl mx-auto mt-24">
      {/* Left arrow */}
      <button
        onClick={scrollPrev}
        aria-label="Previous"
        ...
        <div className="flex gap-4">
          {slides.map((slide) => (
            <div
              ...
              style={{ flex: "0 0 calc(33.333% - 11px)" }}
            >
              {/* Background image — drives the card height */}
              <img
                src={slide.img}
                alt={slide.heading}
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-6">
                <div>
                  <span className="text-black text-xs mt-5  font-medium tracking-wide">
                    {slide.tag}
                  </span>
                  <h2 className={slide.customeCSS}>
                    {slide.heading}
                  </h2>
                </div>

                <button
                  className={`${slide.btnCss} ${slide.btnColor}`}
                >
                  {slide.btnLabel}
